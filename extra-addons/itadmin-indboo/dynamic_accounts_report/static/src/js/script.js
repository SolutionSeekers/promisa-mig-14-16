odoo.define('dynamic_accounts_report.DynamicTbMain', function(require) {
'use strict';
		...
		print_pdf: function(e) {
			...
			self._rpc({
				...
				var action = {
					...
					'report_name': 'dynamic_accounts_report.ins_report_financial',
					'report_file': 'dynamic_accounts_report.ins_report_financial',
					'data': {
						'js_data': data
					},
					'context': {
