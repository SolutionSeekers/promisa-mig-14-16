    ...
    def action_validar(self):
        ...
        if employee:
            if self.tipo_de_incidencia=='Cambio reg. patronal':
                self.registro_patronal_ant = employee.registro_patronal.id
                ...
                employee.write({'active':True, 'registro_patronal': self.registro_patronal.id})
                if self.contract_id:
       ...
       if self.state == 'draft':
         self.write({'state':'cancel'})
          ...
          if self.tipo_de_incidencia == 'Reingreso':
              ...
              employee.write({'registro_patronal': self.registro_patronal_ant.id})
              employee.write({'active':True})
          elif self.tipo_de_incidencia == 'Cambio salario':
              if self.contract_id:
                 self.contract_id.write({'state':'open',
